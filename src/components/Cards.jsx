...
function Cards(props) {
  return (
    <ul data-aos="fade-up" data-aos-duration="500">
      <li className="item m-auto hover:text-[#CC0909] hover:scale-105 cursor-pointer  rounded-md bg-purple-300 md:w-[80%] shadow-md hover:shadow-xl transition-all duration-300 ">
        <h1>{props.name}</h1>
        <img
